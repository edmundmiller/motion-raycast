    ...
    <Detail
      ...
      metadata={
        <Detail.Metadata>
          ...
          <Detail.Metadata.Label title="Due Date" text={task.dueDate ? new Date(task.dueDate).toLocaleDateString() : "No due date"} />
          ...
          {task.schedulingIssue && (
            <Detail.Metadata.Label title="Scheduling Issue" text="Yes" />
          )}
        </Detail.Metadata>
      }
      actions={
